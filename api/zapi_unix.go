...
func SQLTables(statementHandle SQLHSTMT,
	CatalogName *SQLWCHAR, NameLength1 SQLSMALLINT,
	SchemaName *SQLWCHAR, NameLength2 SQLSMALLINT,
	TableName *SQLWCHAR, NameLength3 SQLSMALLINT,
	TableType *SQLWCHAR, NameLength4 SQLSMALLINT) (ret SQLRETURN) {
	r := C.SQLTablesW(C.SQLHSTMT(statementHandle),
		(*C.SQLWCHAR)(CatalogName), C.SQLSMALLINT(NameLength1),
		(*C.SQLWCHAR)(SchemaName), C.SQLSMALLINT(NameLength2),
		(*C.SQLWCHAR)(TableName), C.SQLSMALLINT(NameLength3),
		(*C.SQLWCHAR)(TableType), C.SQLSMALLINT(NameLength4))
	return SQLRETURN(r)
}

func SQLColumns(statementHandle SQLHSTMT,
	CatalogName *SQLWCHAR, NameLength1 SQLSMALLINT,
	SchemaName *SQLWCHAR, NameLength2 SQLSMALLINT,
	TableName *SQLWCHAR, NameLength3 SQLSMALLINT,
	ColumnName *SQLWCHAR, NameLength4 SQLSMALLINT) (ret SQLRETURN) {
	r := C.SQLColumnsW(
		C.SQLHSTMT(statementHandle),
		(*C.SQLWCHAR)(CatalogName), C.SQLSMALLINT(NameLength1),
		(*C.SQLWCHAR)(SchemaName), C.SQLSMALLINT(NameLength2),
		(*C.SQLWCHAR)(TableName), C.SQLSMALLINT(NameLength3),
		(*C.SQLWCHAR)(ColumnName), C.SQLSMALLINT(NameLength4))
	return SQLRETURN(r)
